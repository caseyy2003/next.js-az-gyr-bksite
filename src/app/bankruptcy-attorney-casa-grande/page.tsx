...
export const metadata = generateMetadata("Casa Grande"); // Dynamic Metadata
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <p className="mb-6 text-lg">
        If you are struggling with overwhelming debt in <strong>Casa Grande, Arizona</strong>, filing for bankruptcy may provide a path to financial relief.
      ...
      <p className="mb-4">
        ...
        **Chapter 7** and **Chapter 13** bankruptcy can help you make an informed decision.
      </p>
      ...
      <details className="border rounded-md p-4 my-4">
        <summary className="font-semibold cursor-pointer">How do I know if I qualify for bankruptcy in Casa Grande?</summary>
