...
export const metadata = {
  title: "Bankruptcy Attorney in Goodyear | Trusted Debt Relief",
  description: "Looking for a bankruptcy attorney in Goodyear, Arizona? Get expert legal assistance for Chapter 7 and Chapter 13 bankruptcy filings.",
  keywords: "Bankruptcy Attorney Goodyear, Goodyear Chapter 7 Lawyer, Goodyear Chapter 13 Attorney, Debt Relief in Goodyear"
};
  ...
  return (
    <div className="container mx-auto p-6">
        ...
        <script 
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "LegalService",
              "name": "Goodyear Bankruptcy Attorney",
              "description": "Experienced virtual bankruptcy services in Goodyear, Arizona, assisting individuals with Chapter 7 and Chapter 13 bankruptcy filings.",
              "address": {
                "@type": "PostalAddress",
              ...
              "url": "https://yourwebsite.com/bankruptcy-attorney-goodyear"
            })
          }} 
        />
      </Head>
      ...
      <p className="mb-6 text-lg">
        If you are struggling with overwhelming debt in Goodyear, bankruptcy may be a viable solution. Our experienced attorneys offer virtual bankruptcy services, allowing you to file for Chapter 7 or Chapter 13 bankruptcy remotely. We are committed to helping you regain financial control.
      </p>
