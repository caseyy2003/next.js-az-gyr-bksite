...
export const metadata = {
  title: "Bankruptcy Attorney in Goodyear | Virtual Bankruptcy Services",
  description: "Need a bankruptcy attorney in Goodyear, Arizona? We provide expert virtual bankruptcy services, helping you file for Chapter 7 or Chapter 13 from home.",
  keywords: "Bankruptcy Attorney Goodyear, Chapter 7 Lawyer Goodyear, Chapter 13 Attorney Goodyear, Virtual Bankruptcy Services"
};
...
const GoodyearBankruptcyPage = () => {
  return (
    <div>
        ...
        <script 
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Experienced virtual bankruptcy services in Goodyear, Arizona, helping individuals with Chapter 7 and Chapter 13 filings.",
              "address": {
                "@type": "PostalAddress",
      ...
      {/* Page Content */}
      <h1>Bankruptcy Attorney in Goodyear</h1>
      <p>
        If you’re struggling with overwhelming debt in Goodyear, we can help.
