...
export const metadata = {
  title: "Bankruptcy Attorney in Tempe | Expert Legal Help",
...
const TempeBankruptcyPage = () => {
  return (
    <div>
        ...
        <script 
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Experienced virtual bankruptcy services in Tempe, Arizona, helping individuals with Chapter 7 and Chapter 13 filings.",
              "address": {
                "@type": "PostalAddress",
      ...
      {/* Page Content */}
      <h1>Bankruptcy Attorney in Tempe</h1>
      <p>We provide expert bankruptcy services in Tempe, Arizona.</p>
