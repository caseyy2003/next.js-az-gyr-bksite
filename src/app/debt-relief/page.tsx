  ...
  return (
    <div className="container mx-auto py-16 px-4">
      ...
      <ul className="list-disc ml-6 mb-6">
        <li>
          <strong>Decades of Experience:</strong> Our firm has successfully helped countless individuals and families across Arizona resolve their debts and rebuild their financial health.
        </li>
        <li>
          <strong>Personalized Debt Relief Plans:</strong> We assess your financial situation and create a customized strategy that best suits your needs.
        </li>
        <li>
          <strong>Protection from Creditors:</strong> We help stop creditor harassment, lawsuits, and wage garnishments so you can move forward with peace of mind.
        </li>
      </ul>
      ...
      <ul className="list-disc ml-6 mb-6">
        <li>
          <strong>Debt Settlement:</strong> Negotiating with creditors to reduce the total amount owed.
        </li>
        <li>
          <strong>Debt Consolidation:</strong> Combining multiple debts into one manageable monthly payment.
        </li>
        <li>
          <strong>Bankruptcy Solutions:</strong> Exploring Chapter 7 and Chapter 13 bankruptcy options when necessary.
        </li>
        <li>
          <strong>Legal Defense Against Creditors:</strong> Protecting your rights and stopping unfair collection practices.
        </li>
      </ul>
      ...
      <ol className="list-decimal ml-6 mb-6">
        <li>
          <strong>Free Consultation:</strong> We start with a no-obligation consultation to discuss your financial situation and explore available solutions.
        </li>
        <li>
          <strong>Personalized Strategy:</strong> Our legal team designs a custom plan to help you eliminate or manage your debt efficiently.
        </li>
        <li>
          <strong>Execution and Protection:</strong> We handle negotiations, legal filings, and creditor communications to ensure a smooth debt relief process.
        </li>
      </ol>
      ...
      <p className="mt-8">
        ...
        for additional details on debt relief options.
      </p>
