...
export const metadata = {
  title: "Bankruptcy Attorney in Scottsdale | Trusted Debt Relief",
  description: "Looking for a bankruptcy attorney in Scottsdale, Arizona? Get expert legal assistance for Chapter 7 and Chapter 13 bankruptcy filings.",
  keywords: "Bankruptcy Attorney Scottsdale, Scottsdale Chapter 7 Lawyer, Scottsdale Chapter 13 Attorney, Debt Relief in Scottsdale"
};
  ...
  return (
    <div className="container mx-auto p-6">
        ...
        <script 
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "LegalService",
              "name": "Scottsdale Bankruptcy Attorney",
              "description": "Experienced virtual bankruptcy services in Scottsdale, Arizona, assisting individuals with Chapter 7 and Chapter 13 bankruptcy filings.",
              "address": {
                "@type": "PostalAddress",
              ...
              "url": "https://yourwebsite.com/bankruptcy-attorney-scottsdale"
            })
          }} 
        />
      </Head>
      ...
      <p className="mb-6 text-lg">
        If you are struggling with overwhelming debt in Scottsdale, bankruptcy may be a viable solution. Our experienced attorneys offer virtual bankruptcy services, allowing you to file for Chapter 7 or Chapter 13 bankruptcy remotely. We are committed to helping you regain financial control.
      </p>
      ...
      <h2 className="text-2xl font-semibold mt-6">Who Qualifies for Bankruptcy in Scottsdale?</h2>
      <p className="mb-4">
