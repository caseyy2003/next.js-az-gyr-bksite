...
export const metadata = {
  title: "Bankruptcy Attorney in Chandler | Expert Virtual Debt Relief",
  description: "Need a bankruptcy attorney in Chandler, Arizona? We provide expert virtual bankruptcy services, helping you file for Chapter 7 or Chapter 13 from home.",
  keywords: "Bankruptcy Attorney Chandler, Chapter 7 Lawyer Chandler, Chapter 13 Attorney Chandler, Virtual Bankruptcy Services"
};
...
const ChandlerBankruptcyPage = () => {
  return (
    <div>
        ...
        <script 
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Experienced virtual bankruptcy services in Chandler, Arizona, helping individuals with Chapter 7 and Chapter 13 filings.",
              "address": {
                "@type": "PostalAddress",
      ...
      {/* Page Content */}
      <h1>Bankruptcy Attorney in Chandler</h1>
      <p>
        If you’re struggling with overwhelming debt in Chandler, we can help.
