...
export const metadata = {
  title: "Bankruptcy Attorney in Peoria | Trusted Debt Relief",
  description: "Looking for a bankruptcy attorney in Peoria, Arizona? Get expert legal assistance for Chapter 7 and Chapter 13 bankruptcy filings.",
  keywords: "Bankruptcy Attorney Peoria, Peoria Chapter 7 Lawyer, Peoria Chapter 13 Attorney, Debt Relief in Peoria"
};

const PeoriaBankruptcyPage = () => {
  return (
    <div className="container mx-auto p-6">
        ...
        <script 
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "LegalService",
              "name": "Peoria Bankruptcy Attorney",
              "description": "Experienced virtual bankruptcy services in Peoria, Arizona, assisting individuals with Chapter 7 and Chapter 13 bankruptcy filings.",
              "address": {
                "@type": "PostalAddress",
              ...
              "url": "https://yourwebsite.com/bankruptcy-attorney-peoria"
            })
          }} 
        />
      </Head>
      ...
      {/* Page Content */}
      <h1 className="text-3xl font-bold mb-4">Bankruptcy Attorney in Peoria</h1>
      <p className="mb-6 text-lg">
        If you are struggling with overwhelming debt in Peoria, bankruptcy may provide the relief you need. Our experienced attorneys offer virtual bankruptcy services, allowing you to file for Chapter 7 or Chapter 13 bankruptcy remotely. We are committed to helping you regain financial control.
      </p>
      ...
      <h2 className="text-2xl font-semibold mt-6">Who Qualifies for Bankruptcy in Peoria?</h2>
      <p className="mb-4">
...
export default PeoriaBankruptcyPage;
