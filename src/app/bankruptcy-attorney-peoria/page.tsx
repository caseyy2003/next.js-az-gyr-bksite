...
export const metadata = generateMetadata("Peoria"); // Dynamic Metadata
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <p className="mb-6 text-lg">
        Struggling with overwhelming debt in Peoria? Filing for bankruptcy may provide a financial reset. Our experienced bankruptcy attorneys offer **virtual legal services**, allowing you to complete the process remotely. Whether you need help with **Chapter 7 bankruptcy** to eliminate debt or **Chapter 13 bankruptcy** to restructure it, we provide expert legal guidance.
      </p>
      ...
      <h2 className="text-2xl font-semibold mt-6">Benefits of Filing for Bankruptcy in Peoria</h2>
      <p className="mb-4">
