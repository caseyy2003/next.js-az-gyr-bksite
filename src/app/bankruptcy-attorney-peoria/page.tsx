...
export const metadata = {
  title: "Bankruptcy Attorney in Peoria | Expert Legal Help",
...
const PeoriaBankruptcyPage = () => {
  return (
    <div>
        ...
        <script 
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Experienced virtual bankruptcy services in Peoria, Arizona, helping individuals with Chapter 7 and Chapter 13 filings.",
              "address": {
                "@type": "PostalAddress",
      ...
      {/* Page Content */}
      <h1>Bankruptcy Attorney in Peoria</h1>
      <p>We provide expert bankruptcy services in Peoria, Arizona.</p>
